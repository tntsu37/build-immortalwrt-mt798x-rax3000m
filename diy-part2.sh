...
#修改wifi名称（mtwifi-cfg）
sed -i 's/ImmortalWrt-2.4G/Wireless/g' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
sed -i 's/ImmortalWrt-5G/Wireless-5G/g' package/mtk/applications/mtwifi-cfg/files/mtwifi.sh

#修改闪存为256M版本(这是针对原厂128闪存来的，但又要编译256M固件来的,即自己仓库的256不用，但别人128的仓库要）
